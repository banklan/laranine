    ...
    data(){
        return{
            ...
            authMenu: [
                ...
                {title: "Services", path: "/admin/services", icon:"constructor"},
                {title: "Portfolios", path: "/admin/portfolios", icon:"briefcase-alt"},
                {title: "Reviews", path: "/admin/reviews", icon:"feedback"},
